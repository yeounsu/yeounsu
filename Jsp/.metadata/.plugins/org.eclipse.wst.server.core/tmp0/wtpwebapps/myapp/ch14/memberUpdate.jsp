					...
					<td align="center" valign="middle" bgcolor="#FFFFCC">
						<table border="1" cellpadding="2" align="center" width="600">
							...
							<tr>
								<td>성별</td>
								<td>
									남<input type="radio" name="gender" value="1"<%if(bean.getGender().equals("1"))out.print("checked"); %>>
									남<input type="radio" name="gender" value="1"<%if(bean.getGender().equals("2"))out.print("checked"); %>>

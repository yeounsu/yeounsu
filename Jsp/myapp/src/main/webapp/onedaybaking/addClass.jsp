  ...
  <div class="modal-content">
    ...
    function categoryChange(e) {
		...
		function test() {
	        ...
	        var checkedItems = [];
	        var lists = ["와이파이를 제공해요", "포토존이 있어요", "주차공간이 있어요", "반려동물 동반이 가능해요", "간단한 음료 및 다과를 제공해요", "앞치마 및 장갑을 제공해요", "포장 용기를 제공해요", "손세정제가 비치 되어있어요", "아이 동반은 추천하지 않아요", "실내 소독을 해요", "날카로운 도구들을 많이 사용해요", "거리두기를 준수해요"];
			var a = 0;
			
	        checkboxes.forEach(function(checkbox) {
	            if (checkbox.checked) {
	                checkedItems.push(lists[a]);
	            } else {
	                checkedItems.push(0);
	            }
	            a++;

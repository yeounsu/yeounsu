	...
	public boolean allInsertItem(HttpServletRequest req, String id) {
		...
		try {
			...
			if(pstmt.executeUpdate()==1) {
		        ...
		        pstmt.setString(5, multi.getParameter("itemperiod"));
		        pstmt.setString(6, "N");
		        pstmt.setString(7, multi.getParameter("itemimg"));
		        pstmt.setString(8, multi.getParameter("itemimg1"));
		        pstmt.setString(9, multi.getParameter("itemimg2"));
		        pstmt.setString(10, multi.getParameter("itemimg3"));
		        pstmt.setString(11, multi.getParameter("itemimg4"));
		        pstmt.setString(12, multi.getParameter("itemcontent"));
		        pstmt.setString(13, id);

		        ...
		        $.ajax({
		            ...
		            success: function(response) {
		                ...
		                for (var i = istart; i < ivlist.length; i++) {
		                    ...
		                    html += "<h5 class='card-title'><small>" + ibean.classname + "</small></h5>";
		                    html += "<p class='card-text'><small>" + ibean.offercontent + "</small></p>";
		                    html += "</div>";
		                    html += "<div class='card-footer text-end'>";
		                    html += "<small class='text-body-secondary'> " + ibean.classprice + "원</small>";
		                    html += "</div>";
		                    html += "</div>";
		                    html += "</a>";
		                    html += "</div>";
	...
	<div style="width: 55%;  margin: auto;">
		...
		<div class="containers">
			<div class="button-containers">
				<button id="btnPanel1" class="btnPanel active" onclick="showPanel('panel1', 'btnPanel1')">신청한 클래스 (<%=items %>)</button>
